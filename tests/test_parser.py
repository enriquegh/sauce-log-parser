...
def test_read_log_success(tmpdir, capsys):
  ...
  total: 6.361999750137329\n"""
    ...
    sauce_parser.read_log("{}/log_test.log".format(test_log.dirname), "duration")
